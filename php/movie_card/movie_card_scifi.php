<?php
    ...
    $sql_querie = "SELECT movie_id, movie_name, movie_genre, movie_actor, movie_year, movie_price, movie_info, movie_img FROM movies WHERE movie_genre = 'Science Fiction'";
